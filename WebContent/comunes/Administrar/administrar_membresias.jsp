...
<h2>Buscador</h2>
	  <p>Busca membresias a partir de sus datos.</p>  
	  <input class="form-control" id="myInput" type="text" placeholder="Buscador...">
		<div class="container">
			<h2 align="center">Membresias</h2>
			<form action="TipoMembresia?op=Listar" method="post">
			...
			<div class="form-group" align="right">
				<a href="TipoMembresia?op=Regresar" class="btn btn-info">Regresar</a>
			</div>
		</div>
	</div>
	<!-- /.container -->
